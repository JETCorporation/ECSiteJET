...
class LC_Page_Admin_Products_Product_Ex extends LC_Page_Admin_Products_Product
{
    ...
    public function lfInitFormParam(&$objFormParam, $arrPost)
    {
    	...
    	$objFormParam->addParam('アレルギー表示', 'allergy_id', INT_LEN, 'n', array('NUM_CHECK', 'MAX_LENGTH_CHECK'));
    ...
    public function lfInsertDummyProductClass($arrList)
    {
    	...
    	// 配列の添字を定義
    	$checkArray = array('product_class_id', 'product_id', 'product_code', 'stock', 'stock_unlimited', 'price01', 'price02','allergy_id', 'sale_limit', 'deliv_fee', 'point_rate' ,'product_type_id', 'down_filename', 'down_realfilename');
    ...
    public function lfRegistProduct(&$objUpFile, &$objDownFile, $arrList)
    {
    	...
    	$sqlval['allergy_id'] = $arrList['allergy_id'];
